...
if TYPE_CHECKING:
    from scholaraio.core.config import Config, LLMConfig
    from scholaraio.services.ingest_metadata import PaperMetadata
...
class MetadataExtractor(Protocol):
    ...
    def extract(self, filepath: Path) -> PaperMetadata:
        ...
        Returns:
            填充后的 :class:`~scholaraio.services.ingest_metadata.PaperMetadata` 实例。
        """
        ...
